...
public class Clubs_Fragment extends Fragment {
    ...
    int[] images = {R.drawable.twentyfourhourfinale, R.drawable.ast, R.drawable.cya};
    int[] imagestwo = {R.drawable.abeamconsulting, R.drawable.boldhorizons, R.drawable.cna};
